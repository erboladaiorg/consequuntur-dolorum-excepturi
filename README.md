...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@erboladaiorg/consequuntur-dolorum-excepturi">
    <img alt="" src="https://img.shields.io/npm/v/@erboladaiorg/consequuntur-dolorum-excepturi.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@erboladaiorg/consequuntur-dolorum-excepturi.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@erboladaiorg/consequuntur-dolorum-excepturi">
...
```bash
npm install @erboladaiorg/consequuntur-dolorum-excepturi
```

Use with [Node.js](https://nodejs.org/en/), [Browserify](https://browserify.org/), or [webpack](https://webpack.github.io/):

```js
const classNames = require('@erboladaiorg/consequuntur-dolorum-excepturi');
...
There is also a [Changelog](https://github.com/erboladaiorg/consequuntur-dolorum-excepturi/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@erboladaiorg/consequuntur-dolorum-excepturi';
...
```js
const classNames = require('@erboladaiorg/consequuntur-dolorum-excepturi/dedupe');
...
```js
const classNames = require('@erboladaiorg/consequuntur-dolorum-excepturi/bind');
...
import classNames from '@erboladaiorg/consequuntur-dolorum-excepturi/bind';
